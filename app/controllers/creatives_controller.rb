class CreativesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @creative.save
        format.html { redirect_to ad_creative_path(@creative.ad, @creative), notice: 'Creative was successfully created.' }
  ...
  private
    ...
    def creative_params
      params.require(:creative).permit(:bid, :adtext, :ad_id)
    end
end
